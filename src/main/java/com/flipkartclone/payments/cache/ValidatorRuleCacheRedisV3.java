...
@Component
@Slf4j
public class ValidatorRuleCacheRedisV3 {
    ...
    private final ValidationRuleParamRepository validationRulesParamsRepository;
    ...
    public ValidatorRuleCacheRedisV3(
            ValidationRulesRepository validationRulesRepository,
            ValidationRuleParamRepository validationRulesParamsRepository,
        ...
        try {
            ...
            if(validatorRules != null && !validatorRules.isEmpty()) {
                log.info("Loaded {} validator rules from Redis cache validatorRules:{}",
                        validatorRules.size(), validatorRules);
